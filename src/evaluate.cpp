...
namespace Stockfish {
    ...
    #else
    Value Eval::evaluate(const Eval::NNUE::Networks&,
                         const Position&,
                         Eval::NNUE::AccumulatorStack&,
                         Eval::NNUE::AccumulatorCaches&,
                         int) {
        return VALUE_ZERO;
    }
    #endif
    ...
    #else
    std::string Eval::trace(Position&, const Eval::NNUE::Networks&) {
